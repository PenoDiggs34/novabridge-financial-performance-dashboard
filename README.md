...
![Executive Summary](images/page1_executive_summary.jpg)

KPI cards for Revenue, Budget, Variance, and EBITDA. Line chart showing 
Actual vs Budget monthly trend - the Q3 dip and Q4 recovery tell the 
entire story visually.

---

**Page 2 — P&L Variance by Division**

![P&L Variance by Division](images/page2_variance_by_division.jpg)

Clustered bar charts comparing Actual vs Budget by division and monthly 
variance. Summary table with full P&L metrics per division.

---

**Page 3 — Regional Performance**

![Regional Performance](images/page3_regional_performance.jpg)

Revenue comparison and variance % by region. Confirms the macro-driven 
nature of the shock - all regions affected uniformly.
---
